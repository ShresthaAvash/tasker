...
@section('css')
<style>
    .card-primary.card-tabs .card-header { background-color: #343a40; border-bottom: none; }
    .card-primary.card-tabs .nav-link { border: 0; color: rgba(255, 255, 255, 0.7); transition: all 0.2s ease-in-out; border-top: 3px solid transparent; margin-bottom: -1px; }
    .card-primary.card-tabs .nav-link.active { background-color: #fff; color: #343a40; border-top-color: #007bff; }
    .card-primary.card-tabs .nav-link:not(.active):hover { color: #ffffff; border-top-color: #6c757d; }
    ...
    .select2-container--default .select2-selection--multiple .select2-selection__choice { background-color: #007bff; border-color: #006fe6; color: #fff; }
...
$(document).ready(function() {
    ...
    // --- Existing modal and initial service assignment logic ---
