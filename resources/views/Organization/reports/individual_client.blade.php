        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-2">
                        <input type="text" id="search-input" class="form-control" placeholder="Search by Task or Service..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-2">
                        <select id="service-filter" class="form-control" multiple="multiple"></select>
                    </div>
                    <div class="col-md-2">
                        <select id="staff-filter" class="form-control" multiple="multiple"></select>
                    </div>
                    <div class="col-md-2">
...
<div id="report-table-container">
    @include('Organization.reports._individual_client_report_table', compact('taskInstances', 'sort_by', 'sort_order'))
</div>
@stop
...
$(document).ready(function() {
    ...
    $('#search-input, #service-filter, #staff-filter, #status-filter, #year-filter, #month-filter').on('keyup change', function() {
        fetch_report_data(1);
    });
    ...
    $('#reset-filters').on('click', function() {
        ...
        $('#staff-filter').val(null).trigger('change');
